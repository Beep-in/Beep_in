    ...
    <div className="w-full">
      ...
      <div className="absolute left-24 top-52 list-none flex gap-8 flex-col">
        ...
        >
          ...
          <li className="pl-4 font-karla">Overview</li>
        </button>
        <button
        ...
        >
          <AiOutlineRight className="mt-1 ml-2" />
          <li className="pl-4 font-karla">Report</li>
        </button>
        <button
        ...
        >
          <AiOutlineRight className="mt-1 ml-2" />
          <li className="pl-4 font-karla">SMS List</li>
        </button>
      </div>
      {statistics.overview && (
        <div className="h-96 w-3/4 mt-16 absolute right-10 ">
          <h1
            className="font-bold font-karla"
          >
            Today's Overview
          </h1>
          <div className="flex">
            <div className="flex">
              <div className="flex mt-2 w-1/2">
                <div className="">
                  ...
                  <div className="flex mt-4">
                    ...
                    <div className="pl-8">
                      <p className="text-xs font-inter text-black text-opacity-50">Your groups</p>
                      <p>50</p>
                    </div>
                  ...
                  <div className="">
                    <div className="flex mt-2 w-2/3 border-b-2 border-solid pb-2 font-karla ">
              ...
              <div className="block ml-10">
                <table className="w-[18vw] h-36 font-inter text-sm">
            ...
            <div className="block absolute right-0 font-inter text-sm">
      ...
      {statistics.report && (
        <div className="h-96 w-3/4 mt-20 absolute right-10 ">
          ...
          <div className="mt-4">
            <button className="bg-white text-[#6C63FF] shadow-xl rounded-lg h-14 w-40 text-center font-karla text-lg">
              Sent
            </button>
            <button className="bg-[#6C63FF] text-white rounded-lg h-14 w-40 text-center ml-4 font-karla text-lg">
              Recieved
            </button>
          </div>
          <div className="mt-12">
            ...
            <input
              type="date"
              placeholder="Start date"
              className="h-14 w-56 ml-14 border-solid border border-[#6C63FF] border-opacity-10 rounded-lg pl-4 pr-2 font-inter"
            />
          </div>
          <div className="flex mt-6">
            ...
            <select className="block border-solid border border-[#6C63FF] border-opacity-10 h-14 font-inter rounded-lg w-56 pl-3  ml-14">
