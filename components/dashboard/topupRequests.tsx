      ...
      {mode.topup && (
       <div className='w-1/2 h-auto pb-10 pt-6 mt-14 ml-auto mr-auto shadow-sm shadow-gray-400'>
          ...
          <div className='flex flex-col items-center mt-10'>
            <button onClick={() => dispatch({type:"confirmTopup"})} className='h-10 w-40 bg-blue-500 text-white rounded-lg'>Top up</button>
          </div>
          <div className='flex flex-col items-center mt-4'>
            <button className='h-10 w-40 bg-white text-blue-500 border-2 border-blue-500 rounded-lg'>Buy</button>
            </div>
        </div>
     )}
     {mode.confirmTopup && (
            ...
            <div className='h-28 w-[15vw] bg-white ml-auto mr-auto shadow-sm shadow-slate-400 rounded-2xl mt-4 flex'>
              <button><Plus className='text-3xl ml-6 text-blue-500' /></button>
            <h1 className='text-3xl text-center pt-10 pl-4'>40 SMS</h1>
             <button><Dash className='text-3xl ml-6 text-blue-500' /></button>
            </div>
            </div>
            <div>
          ...
          <div>
            ...
            <div className='flex ml-10 mt-6'>
              <input type="text" placeholder='Name of agent' className='h-16 w-72 border-2 border-blue-500 border-opacity-20 rounded-xl pl-4'/>
              <input type="text" placeholder='Type of agent' className='h-16 w-72 border-2 border-blue-500 border-opacity-20 rounded-xl pl-4 ml-32'/>
            </div>
          </div>
            <div className='flex flex-col items-center mt-10 '>
              <button onClick={() => dispatch({type: "done"})} className='h-10 w-40 bg-blue-500 text-white rounded-lg'>Confirm Top up</button>
            </div>
            <div className='flex flex-col items-center mt-4'>
              <button className='h-10 w-40 bg-white text-blue-500 border-2 border-blue-500 rounded-lg'>Cancel</button>
              </div>
          </div>
      ...
      {mode.done && (
        <div className='w-1/3 h-[70vh] pb-10 pt-14 mt-32 ml-auto mr-auto shadow-sm shadow-gray-400'>
          ...
          <div className='flex flex-col items-center mt-24 '>
              <button onClick={()=> dispatch({type: "approveTopup"})} className='h-10 w-40 bg-blue-500 text-white rounded-lg'>Done</button>
            </div>
          </div>
      )}
      {mode.approveTopup && (
               ...
               <div className='flex flex-col items-center mt-10 '>
                 <button  className='h-10 w-40 bg-blue-500 text-white rounded-lg'>Approve Top up</button>
               </div>
               <div className='flex flex-col items-center mt-4'>
                 <button className='h-10 w-40 bg-white text-blue-500 border-2 border-blue-500 rounded-lg'>Deny</button>
                 </div>
             </div>
      )}
    </div>
