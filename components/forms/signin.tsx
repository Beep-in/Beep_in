        ...
        <div>
            ...
            <div className="float-right w-1/2 h-auto pb-10" >
             ...
             <form action="" className='block mt-16  ml-[25%]'>
                ...
                <input type="checkbox" className='h-4 w-4 mt-4 border-solid border border-[#6C63FF] border-opacity-10 flex' /><span className='pl-2 font-karia pt-3'>Remember me</span>
                ...
                <p className='font-karia pt-8 text-center'>Don't have an account?<Link href = "/auth/login" className='text-[#6C63FF] pl-1'>Sign up</Link></p>
             </form> 
